...
from funks.func import first_func, second_func, third_func, fourth_func, fifth_func
...
def main():
    ...
    st.markdown("**Input an expression/equation with the following functions: f1, f2, f3, f4, f5**")
